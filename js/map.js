...
function CreateUrlFlickr(dataFilter) {
    ...
    flickrMarkers = [];
    let url = 'https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=d2eab41b196d9ba760b21e0b3004b48d&has_geo=1&extras=geo&per_page=50&page=1&format=json&nojsoncallback=1';
